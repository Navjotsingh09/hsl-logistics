  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <nav className="container mx-auto px-4 py-4 relative" aria-label="Main navigation">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="/" className="font-medium text-foreground hover:text-primary transition-colors" aria-current="page">Home</Link>
      ...
      <main id="main-content">
        <section className="relative bg-gradient-to-br from-[#3F3D56] via-[#3F3D56]/90 to-[#3F3D56] text-white overflow-hidden" aria-labelledby="hero-heading">
          <Image src="/hero-delivery.jpg" alt="HSL Logistics delivery team loading packages into a freight van at a distribution center" fill sizes="100vw" className="object-cover opacity-30" priority />
          ...
          <div className="container mx-auto px-4 py-24 md:py-32 relative">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full text-sm font-medium mb-6 border border-white/20">
                ...
                Trusted Logistics Partner Since 2009
              </div>
              <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-balance">
                Delivering Excellence in <span className="text-[#009DCA]">Global Freight and Logistics</span>
              </h1>
              <p className="text-lg md:text-xl text-[#EEEEEE] mb-8 leading-relaxed text-pretty">
                HSL Logistics offers end-to-end freight and supply chain solutions tailored to your business.
                From road and ocean to air freight, we ensure fast, reliable, and secure shipping across 120+ countries.
              </p>
        ...
        {/* Stats Section */}
        <section className="bg-primary text-primary-foreground py-12" aria-label="HSL Logistics key statistics">
        ...
        <section className="py-20 md:py-28 bg-background" aria-labelledby="services-heading">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 id="services-heading" className="text-3xl md:text-4xl font-bold mt-3 mb-4 text-foreground">
                Comprehensive Freight and Logistics Solutions
              </h2>
              <p className="text-muted-foreground text-lg">
                From local deliveries to international cargo, we provide a full range of transportation and supply chain services to keep your business moving.
              </p>
            </div>
              ...
              {[
                {
                  icon: Truck,
                  title: "Road Freight",
                  description: "Reliable ground transportation for local, regional, and cross-border deliveries with real-time GPS tracking.",
                },
                {
                  icon: Ship,
                  title: "Ocean Freight",
                  description: "Cost-effective sea shipping with full container load and less-than-container options for international trade.",
                },
                {
                  icon: Plane,
                  title: "Air Freight",
                  description: "Express air cargo services for time-sensitive shipments, with express and standard delivery options worldwide.",
                },
                {
                  icon: Package,
                  title: "Warehousing and Distribution",
                  description: "Secure storage facilities with inventory management, order fulfillment, and cross-docking distribution services.",
                },
              ].map((service) => (
                <article
                  key={service.title}
                ...
                >
                  ...
                  >
                    Learn More <ChevronRight className="h-4 w-4 ml-1" aria-hidden="true" />
                  </Link>
                </article>
              ))}
            </div>
        ...
        {/* About Section */}
        <section className="py-20 md:py-28 bg-muted/30" aria-labelledby="about-heading">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <span className="text-primary font-semibold text-sm uppercase tracking-wider">About HSL Logistics</span>
                <h2 id="about-heading" className="text-3xl md:text-4xl font-bold mt-3 mb-6 text-foreground">
                ...
                <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                  ...
                  itself as a leader in providing comprehensive freight forwarding, warehousing, and supply chain solutions for businesses of all sizes.
                </p>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Our commitment to excellence, combined with cutting-edge tracking technology and a global network 
                  of trusted partners across 120+ countries, enables us to deliver exceptional service and on-time performance every time.
                </p>
                
                <ul className="grid sm:grid-cols-2 gap-4 mb-8" aria-label="Key features of HSL Logistics">
                  {[
                    "24/7 Dedicated Customer Support",
                    "Real-time GPS Shipment Tracking",
                    "Secure and Insured Cargo Handling",
                ...
                <Button size="lg" asChild>
                  <Link href="/about">
                    Learn More About HSL Logistics
                    <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
                  </Link>
                </Button>
              </div>
              ...
              <div className="relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-border relative">
                  <Image src="/delivery-team.jpg" alt="HSL Logistics two-person delivery team carefully unloading packages from a company van at a customer location" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
                </div>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-[#3F3D56] to-[#3F3D56]/90 text-white" aria-labelledby="cta-heading">
          <div className="container mx-auto px-4 text-center">
            <h2 id="cta-heading" className="text-3xl md:text-4xl font-bold mb-4">Ready to Ship Your Cargo?</h2>
            <p className="text-[#EEEEEE] text-lg mb-8 max-w-2xl mx-auto">
              Get a free, no-obligation quote today and discover why thousands of businesses trust HSL Logistics for their freight and supply chain needs.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
              ...
              <div className="flex gap-4">
                {[
                  { name: "Facebook", label: "Follow HSL Logistics on Facebook" },
                  { name: "Twitter", label: "Follow HSL Logistics on Twitter" },
                  { name: "LinkedIn", label: "Connect with HSL Logistics on LinkedIn" },
                  { name: "Instagram", label: "Follow HSL Logistics on Instagram" },
                ].map((social) => (
                  <a
                    key={social.name}
                    href="#"
                  ...
                  >
                    <span className="text-[#EEEEEE] text-xs font-bold">{social.name.charAt(0)}</span>
                  </a>
                ))}
              </div>
            </div>
